  ...
  return (
    <div className="row-start-2 row-end-3 col-start-1 flex flex-wrap mr-4 items-center justify-center songs-filter relative lg:pl-20">
      <div className="flex flex-col pr-10">
        <h1 className="text-[40px] leading-none mb-8">
          ...
          <span className="relative">
            lexical search
            <span ref={underlineRef} className="block absolute bottom-0 left-0 h-[4px] bg-green-600"></span>
          </span>
          .
        </h1>
      ...
      <div className="row-start-3 row-end-4 col-start-1">
        ...
        <h1 className="text-[40px] leading-none mt-5">Here are some ways you can filter your music in more depth</h1>
        <div className="mt-16">
