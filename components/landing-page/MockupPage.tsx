...
export default function MockupPage() {
  ...
  useIsomorphicLayoutEffect(() => {
    if (refs.current) {
      ...
      Flip.from(state, {
        ...
        simple: true,
        scrollTrigger: {
          trigger: document.querySelector(".move"),
          start: "top top",
          end: "+=175",
          scrub: true,
        },
  ...
  return (
    <div className="pt-20 fixed right-0 left-[50%]">
      ...
      <div
        className="absolute h-[600px] max-w-[550px] mx-auto left-0 right-0 bottom-0 grid grid-cols-mockup grid-rows-mockup"
        ref={inputBarRef}
      >
        <div
        ...
        <div className="grid grid-cols-1 grid-rows-5 w-full row-start-2 w-full songs-grid gap-2 px-10">
          <SongCard
            ref={setRefs}
            item={{
              link: "/imag1.jpg",
