...
export const SwiperButtons = forwardRef<Ref, Props>((props, ref) => {
  return (
    <div>
      <button onClick={() => props.swiperRef.current?.slidePrev()} ref={prevButtonRef} className="text-lg px-3 py-3 bg-[#F6F4F4] text-white w-[60px] h-[60px]">
      ...
      <button onClick={() => props.swiperRef.current?.slideNext()} ref={nextButtonRef} className="text-lg px-3 py-3 bg-[#F6F4F4] text-white w-[60px] h-[60px]">
