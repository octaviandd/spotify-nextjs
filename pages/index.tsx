  ...
  return (
    <Layout>
      <div className="grid grid-cols-hero grid-rows-hero relative" id="starter">
        <div className="flex flex-row flex-wrap pt-20 pb-20 lg:pl-20 row-start-1 row-end-2 col-start-1">
          <div className="pb-6 text-[30px] text-slate-400">
            Looking for new music?
          </div>
          <div className="text-[60px] leading-none">
            Spotifier will help you find music based on similarity or lexical
            discovery
          </div>
          <div
            className="pt-6 cursor-pointer group ease-in-out transition duration-200"
            ref={buttonRef}
          >
