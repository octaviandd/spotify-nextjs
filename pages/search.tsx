...
export default function Page() {
  ...
  return (
    <Layout>
      <div className={isModalOpen ? "bg-[#121212] grid grid-cols-search grid-rows-search pt-10 opacity-10 pointer-events-none" : 'bg-[#121212] grid grid-cols-search grid-rows-search pt-10'}>
        <FlyInOutRight>
