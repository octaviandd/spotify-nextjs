    ...
    <div className="flex mr-4 relative lg:pl-20 start-now">
      <div className='flex flex-col mx-auto my-3 h-[1000px]'>
        <div className="relative inline-block z-10 mt-3">
          ...
          <span className="absolute left-0 top-0 h-full w-full z-20 bg-[#00CA4E]" style={{ filter: 'blur(17px)'}}></span>
        </div>
        <div style={{ background: 'linear-gradient(#d2a8ff, #a371f7 10%, #196c2e 70%, #2ea043 80%, #56d364, #000000)' }} className="h-full w-[3px] rounded-md mx-auto"></div>
        <div className="relative inline-block z-10 mt-3">
          <svg aria-hidden="true" height="24" className='rotate-90' viewBox="0 0 24 24" version="1.1" width="24" data-view-component="true">
