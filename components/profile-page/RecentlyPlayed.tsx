  ...
  return (
    <div className='px-10 pl-20'>
      ...
      <div className='max-w-[900px]'>
        ...
        >
          {recentlyPlayed && recentlyPlayed.map((tracks, index) => (
          ...
          {/* {recentlyPlayed && [1,2,3].map((tracks, index) => {
            <SwiperSlide>
              <div className='flex flex-col'>
                ...
                {tracks.map((track, i) => (
                  <div className='border rounded-md px-2 py-1 flex items-center justify-between' key={i}>
                     <div>
                      <div className='mb-1 font-semibold'>{track.track.artists[0].name}</div>
                      <div className='flex items-center'>
                        <div className="w-[20px] h-[20px] mr-2">
                          <img src={track.track.album?.images[2].url} className="w-[20px] h-[20px]"/>
                        </div>
                        <div className='text-slate-500'>
                          {track.track.name}
                        </div>
